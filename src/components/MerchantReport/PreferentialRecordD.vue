<template>
	...
	<div>
		...
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>物业分配优惠记录</el-breadcrumb-item>
		</el-breadcrumb>
		<!-- 当前停车场 -->
		...
		<el-card class="box-card">
			<el-tabs v-model="activeName" @tab-click="handleClick">
				<!-- 物业分配优惠记录 -->
				<el-tab-pane label="物业分配优惠记录" name="first">
					<!-- 搜索模块 -->
					<div>
						<el-form :model="ruleForm" :rules="rules" ref="ruleForm" :inline="true" class="demo-ruleForm" size="mini">
							...
							<el-form-item label="使用状态:" prop="name">
								<el-select v-model="ruleForm.region" placeholder="全部" clearable>
									<el-option label="区域一" value="shanghai"></el-option>
									<el-option label="区域二" value="beijing"></el-option>
								</el-select>
							</el-form-item>
					...
					<el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
						...
						<el-table-column prop="couponNum" label="分配车牌号">
						</el-table-column>
				...
				<!-- 活动优惠记录 -->
				<el-tab-pane label="活动优惠记录" name="second">
					<!-- 搜索模块 -->
					<div>
						<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position='right' :inline="true" class="demo-ruleForm"
						 size="mini">
							...
							<!-- 优惠内容 -->
							<el-form-item label="优惠内容:" prop="region">
								<el-select v-model="ruleForm.region" placeholder="全部" clearable>
									<el-option label="区域一" value="shanghai"></el-option>
									<el-option label="区域二" value="beijing"></el-option>
								</el-select>
					...
					<!-- 表格 -->
					<el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
						<el-table-column prop="limit" label="优惠劵名称">
						</el-table-column>
						<el-table-column prop="depositAmount" label="优惠劵内容">
						</el-table-column>
						<el-table-column prop="depositAmount" label="单价">
						</el-table-column>
						<el-table-column prop="depositAmount" label="创建者">
						</el-table-column>
						<el-table-column prop="depositAmount" label="创建时间">
						</el-table-column>
						<el-table-column prop="depositAmount" label="可购买权限">
						</el-table-column>
						<el-table-column prop="depositAmount" label="操作">
						</el-table-column>
					</el-table>
