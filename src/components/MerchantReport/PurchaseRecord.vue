	...
	<div>
		...
		<el-card class="box-card">
			<el-tabs v-model="activeName" @tab-click="handleClick">
				<!-- 购买优惠券记录 -->
				<el-tab-pane label="购买优惠券记录" name="first">	
					<!-- 搜索模块 -->
					<div>
						<el-form :model="ruleForm" :rules="rules" ref="ruleForm"  :inline="true" class="demo-ruleForm" size="mini">
							...
							<!-- 优惠劵名称 -->
							<el-form-item label="优惠劵名称:" prop="region">
								<el-input v-model="ruleForm.name" placeholder="请输入内容" clearable></el-input>
							</el-form-item>
							<!-- 优惠劵内容 -->
							<el-form-item label="优惠劵内容:" prop="region">
								<el-select v-model="ruleForm.region" placeholder="请选择活动区域" clearable>
									<el-option label="区域一" value="shanghai"></el-option>
									<el-option label="区域二" value="beijing"></el-option>
								</el-select>
							</el-form-item>
							<el-form-item label="购买时间:" prop="region">
					...
					<!-- 商户列表 -->
						...
						<el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
							...
							<el-table-column prop="couponNum" label="优惠券名称">
							</el-table-column>
							<el-table-column prop="limit" label="优惠券内容">
							</el-table-column>
							<el-table-column prop="depositAmount" label="数量">
							</el-table-column>
							<el-table-column prop="depositAmount" label="支付金额">
							</el-table-column>
							<el-table-column prop="depositAmount" label="支付方式">
							</el-table-column>
							<el-table-column prop="depositAmount" label="订单编号">
							</el-table-column>
				...
				<!-- 预存账户充值记录 -->
				<el-tab-pane label="预存账户充值记录" name="second">
					<!-- 搜索模块 -->
					<div>
						<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-position='right' :inline="true" class="demo-ruleForm" size="mini">
							<!-- 商户名称 -->
							<el-form-item label="商户名称:" prop="name">
								<el-select v-model="ruleForm.region" placeholder="请选择活动区域" clearable>
									<el-option label="区域一" value="shanghai"></el-option>
							...
							<!-- 充值时间 -->
							<el-form-item label="充值时间:" prop="region">
								<el-date-picker v-model="value1" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
								</el-date-picker>
							</el-form-item>
							<!-- 充值方式 -->
							<el-form-item label="充值方式:" prop="region">
								<el-select v-model="ruleForm.region" placeholder="请选择活动区域" clearable>
									<el-option label="区域一" value="shanghai"></el-option>
									<el-option label="区域二" value="beijing"></el-option>
								</el-select>
					...
					<!-- 商户列表 -->
						...
						<el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
							...
							<el-table-column prop="phone" label="充值金额" width="180">
							</el-table-column>
							<el-table-column prop="couponNum" label="赠送现金">
							</el-table-column>
							<el-table-column prop="limit" label="充值方式">
							</el-table-column>
							<el-table-column prop="depositAmount" label="充值时间">
							</el-table-column>
						<el-table-column prop="depositAmount" label="操作员">
						</el-table-column>
