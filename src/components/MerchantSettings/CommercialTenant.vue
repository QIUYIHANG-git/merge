<template>
	...
	<div>
		...
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>优惠劵设置</el-breadcrumb-item>
		</el-breadcrumb>
		<!-- 当前停车场 -->
		...
		<el-card class="box-card">
			<div class="header-box">
				...
				<el-button type="primary" icon="el-icon-plus"  @click='getAddElectronics()'>新建电子劵</el-button>
			</div>
			...
			<el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange"
			 :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}">
				<el-table-column prop="name" label="优惠劵名称" width="180">
				</el-table-column>
				<el-table-column prop="phone" label="优惠劵内容" width="180">
				</el-table-column>
				<el-table-column prop="couponNum" label="单价">
				</el-table-column>
				<el-table-column prop="limit" label="创建者">
				</el-table-column>
				<el-table-column prop="depositAmount" label="创建时间">
				</el-table-column>
				<el-table-column prop="purchase" label="可购买权限">
				</el-table-column>
				<el-table-column label="账户操作">
					<el-button type="primary" icon="el-icon-bottom" size="mini">下载</el-button>
				</el-table-column>
			</el-table>
...
<script>
	export default {
		...
		methods: {
			...
			getAddElectronics(){
				this.$router.push('/CommercialTenant/AddElectronics')
			}
		}
