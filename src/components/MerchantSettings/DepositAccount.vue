<template>
	...
	<div>
		...
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>预存账户设置</el-breadcrumb-item>
		</el-breadcrumb>
		<!-- 当前停车场 -->
		...
		<el-card class="box-card">
			<div class="header-box">
				...
				<el-button type="primary" icon="el-icon-plus" @click='getDepositAS()'>开通商户预存账户</el-button>
			</div>
			...
			<el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange"
			 :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}">
				...
				<el-table-column prop="couponNum" label="预存金额">
				</el-table-column>
				<el-table-column prop="limit" label="现金充值">
				</el-table-column>
				<el-table-column prop="depositAmount" label="启用状态">
				</el-table-column>
				<el-table-column label="账户操作">
					<el-button type="primary" icon="el-icon-bottom" size="mini">修改</el-button>
					<el-button type="primary" icon="el-icon-bottom" size="mini">注销</el-button>
				</el-table-column>
			</el-table>
...
<script>
	export default {
		...
		methods: {
			...
			getDepositAS(){
				this.$router.push('/DepositAccount/DepositAccountSettings')
			}
